...
if (process.env.NODE_ENV !== "production") {
  ...
  Tabs.propTypes = {
    children: /*#__PURE__*/PropTypes__default['default'].oneOfType([PropTypes__default['default'].func, PropTypes__default['default'].node]).isRequired,
    ...
    index: function index(props, name, compName, location, propName) {
      ...
      } else if (val != null && !typeCheck.isNumber(val)) {
...
var Tab = /*#__PURE__*/React.forwardRef(function Tab(_ref3, forwardedRef) {
  _ref3.isSelected;
...
var TabPanel = /*#__PURE__*/React.forwardRef(function TabPanel(_ref5, forwardedRef) {
  ...
  var ref = composeRefs.useComposedRefs(forwardedRef, ownRef, isSelected ? selectedPanelRef : null);
